						...
						<div class="col-sm-10 col-sm-offset-1">
							...
							if ($vquery->num_rows > 0) {
								...
								<div class="text-center" style="color:black ; font-size: 35px; font-family:Times">
									...
									<a href="#view" data-toggle="modal" class="btn btn-curve btn-primary btn-lg"
										style="background-color: #4682B4 ;color:black ; font-size: 22px; font-family:Times">View
										Ballot</a>
								</div>
								<?php
							} else {
								...
								<form method="POST" id="ballotForm" action="submit_ballot.php">
									...
									<div class="text-center">
										<button type="button" class="btn btn-success btn-curve"
											style='background-color: #9CD095 ;color:black ; font-size: 12px; font-family:Times'
											id="preview"><i class="fa fa-file-text"></i> Preview</button>
										<button type="submit" class="btn btn-primary btn-curve"
											...
											name="vote"><i class="fa fa-check-square-o"></i> Submit</button>
									</div>
								</form>
								<!-- End Voting Ballot -->
								<?php
