<!-- Reset -->
<div class="modal fade" data-backdrop="" id="reset"  style="background:none;border:none;">
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: #d8d1bd ;color:black ; font-size: 15px; font-family:Times ">
            ...
            <div class="modal-footer">
              ...
              <a href="votes_reset.php" class="btn btn-danger btn-curve"style='background-color:  #ff8e88  ;color:black ; font-size: 12px; font-family:Times' ><i class="fa fa-refresh"></i> Reset</a>
            </div>
        </div>
    </div>
</div>